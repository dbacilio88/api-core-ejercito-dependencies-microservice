...
public class DivisionController extends ReactorControllerBase implements IDivisionController {
    ...
    public Mono<ResponseEntity<Object>> doOnFindAllExecute(@RequestParam(required = false) Long statusId,
                                                           @RequestParam(required = false, defaultValue = "10") String limit,
                                                           @RequestParam(required = false, defaultValue = "1") String page) {
        final PageableDto pageableDivision = PageableDto.builder().build();
        return this.service.getAllEntities(statusId, limit, page, pageableDivision)
    ...
    public Mono<ResponseEntity<Object>> doOnFindByIdExecute(@PathVariable(value = "divisionId") Long id) {
